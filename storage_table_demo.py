...
resourcegroup_name = 'vka'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'vka'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
car.price = '$35,000'
table_service.insert_entity('itemstable', car)
print('Created entry for Ford F-150')
